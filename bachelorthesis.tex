...
\begin{figure}[h]	
	\centering
	\includegraphics[width=0.5\textwidth]{Bilder/Screenshots/windows8/win8_startscreen.png} 
...
Es gibt einige grundlegende Touch- und Mausgesten um in der Modern UI Oberfläche zwischen den Apps zu navigieren oder um Optionen oder Einstellungen aufzurufen. 
...
\begin{figure}[h]	
	\centering
	\includegraphics[width=0.5\textwidth]{Bilder/Screenshots/windows8/charm_bar.png} 
...
\begin{figure}[h]	
	\centering
	\includegraphics[width=0.5\textwidth]{Bilder/Screenshots/windows8/apps_changing.png} 
	\caption{Die Gesten zum Durch-wechseln der Apps.}
	\label{fig:appschanging}
\end{figure}  

Die letzte grundlegende Geste, wird benutzt um z.B. Optionen, Einstellungen oder eine Navigationsleiste aufzurufen. 

\begin{figure}[h]	
	\centering
	\includegraphics[width=0.5\textwidth]{Bilder/Screenshots/windows8/app_leisten.png} 
