\begin{lstlisting}[language= Javascript,caption=Vermeidung von Infoboxen und Twitternachrichten sowie Hyperlinks in den Artikeln., label={lst:artikelabsätze}]
